...
const ApplicationTable = ({ slice }) => {
  ...
  return (
    <div className="relative overflow-y-auto max-h-[700px] sm:max-h-[400px] shadow-md border border-gray-200 sm:rounded-lg">
      {applicationData.length > 0 ? (
        ...
        <div className="flex flex-col gap-5 items-center justify-center min-h-[300px]">
          <BsDatabaseFillX size={100} className="text-red-300 animate-bounce" />
          <div className="text-center">
            <h2>No Applications found!</h2>
            <p className="!text-gray-400 mt-3">
              Please click{" "}
              <Link className="text-blue-400 underline underline-offset-4">
                apply
              </Link>{" "}
